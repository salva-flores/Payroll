...
.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
	...
	.state('prueba', {
		...
		controller: 'overtimePayrollCtrl',
	...
	.state('app.dashboard', {
		...
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load([{serie:true,files:['src/vendor/Charts/Chart.js']}])
		...
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				...
				},
				{
					...
					'src/vendor/angular-nvd3/dist/angular-nvd3.min.js'
					]
				}]).then(function () {
	...
	.state('app.over.request', {
		url: '/request',
		templateUrl: 'app/views/overtime.request.html',
		controller: 'overtimeRequestCtrl',
		resolve: {
			parametros: ['$rootScope','$http', function($rootScope, $http){return $http.get('../planilla/api/overParams/'+$rootScope.user.employee)}],
	...
	.state('app.over.detail', {	
		url: '/detail',
		templateUrl: 'app/views/overtime.detail.html',
	...
	.state('app.over.payroll', {	
		url: '/payroll',
		templateUrl: 'app/views/overtime.payroll.html',
		controller: 'overtimePayrollCtrl',
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load([
	...
	.state('app.over.authorize', {	
		url: '/authorize',
		templateUrl: 'app/views/overtime.authorize.html',
		controller: 'overtimeAuthorizeCtrl',
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('app/controllers/overtime.authorize.js');
			}]
		},
		data: {
			title: 'Horas Extras',
	...
	.state('app.assign.deduction', {
		url: '/deduction',
		templateUrl: 'app/views/deduction.html',
		controller: 'deductionCtrl',
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('app/controllers/deduction.js');
			}]
		},
		data: {
	...
	.state('app.cat.ajustes', {
		url: '/ajustes',
		templateUrl: 'app/views/cat.ajustes.html',
		data: {
			title: 'Catalogo de Ajustes',
		}
		})
	.state('app.cat.companies', {
		url: '/companies',
		templateUrl: 'app/views/cat.company.html',
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load([
				{
					insertBefore: '#load_styles_before',
					files: [
					'src/vendor/clockpicker/dist/bootstrap-clockpicker.min.css',
					]
				},
				{
					serie: true,
					files: [
					'src/vendor/clockpicker/dist/jquery-clockpicker.min.js',
					]
				}]).then(function () {
					return $ocLazyLoad.load('app/controllers/cat.company.js');
				});
			}]
		},
		data: {
	...
	.state('app.cat.employees', {
		url: '/employees',
		templateUrl: 'app/views/main.employees.html',
		controller: 'employeesCtrl',
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('app/controllers/main.employees.js');
			}]
		},
		data: {
			title: 'Empleados',
	...
	.state('app.cat.empresas', {
		...
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('src/vendor/jquery.maskedinput/dist/jquery.maskedinput.min.js').then(function () {
					return $ocLazyLoad.load('app/controllers/catCompany.js');
				});
			}]
		},
		data: {
	...
	.state('app.conf.parameters', {
		...
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('app/controllers/app.dashboard.js');
			}]
		},
		data: {
			title: 'Parámetros',
	...
	.state('app.conf.resources', {
		url: '/resources',
		templateUrl: 'app/views/conf.resources.html',
		controller: 'resourcesCtrl',
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('app/controllers/conf.resources.js');
			}]
		},
		data: {
	...
	.state('app.pay.isr', {
		...
		data: {
			title: 'Cálculo del ISR',
		}
		})
	.state('app.pay.payroll', {
		url: '/payroll',
		templateUrl: 'app/views/pay.payroll.html',
		controller: 'payrollCtrl',
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('app/controllers/pay.payroll.js');
			}]
		},
		data: {
	...
	.state('app.sec.profiles', {
		url: '/profiles',
		templateUrl: 'app/views/sec.profile.html',
		controller: 'ControllerCatalogoPerfil',
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('app/pages/CatalogoPerfiles/CatalogoPerfil.js');
			}]
		},
		data: {
			title: 'Perfiles',
	...
	.state('app.sec.users', {
		...
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('app/controllers/sec.user.js');
			}]
		},
		data: {
			title: 'Usuarios',
	...
	.state('user.signup', {
		...
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('app/controllers/session.js');
			}]
		},
		data: {
	...
	.state('user.lockscreen', {
		url: '/lockscreen',
		templateUrl: 'app/views/sec.lockscreen.html',
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('app/controllers/sec.session.js');
			}]
		},
		data: {
	...
	.state('err', {
		abstract: true,
		templateUrl: 'app/common/app.layout.html',
		controller: 'layoutCtrl',
		resolve: {
			deps: ['$ocLazyLoad', function ($ocLazyLoad) {
				return $ocLazyLoad.load('app/controllers/app.layout.js');
			}]
		},
		data:{Auth:false}
		})
